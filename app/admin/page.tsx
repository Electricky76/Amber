    ...
    <div className="flex min-h-full flex-col bg-egg">
      <header className="border-b border-olive/20 bg-moss px-6 py-5">
        <div className="mx-auto flex max-w-2xl flex-wrap items-center justify-between gap-4">
          <p className="font-ui text-[10px] font-semibold uppercase tracking-[0.35em] text-offwhite/90">
            Amber Morrill Events · Dashboard
          </p>
          <Link
            href="/"
            className="font-ui text-xs font-medium uppercase tracking-[0.2em] text-blush underline-offset-4 transition hover:text-offwhite hover:underline"
          >
            View public site
          </Link>
        </div>
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-6 py-14 md:py-20">
        ...
        <section className="mt-12 rounded-sm border border-olive/20 bg-offwhite p-8 shadow-sm">
          ...
          <ul className="mt-6 space-y-4 font-body text-[15px] leading-relaxed text-ink/80">
            <li className="flex gap-3">
              <span className="font-ui text-moss">—</span>
              <span>
        ...
        <p className="mt-10 font-body text-sm leading-relaxed text-ink/60">
          Bookmark this URL for later:{" "}
          <code className="rounded bg-moss/10 px-2 py-0.5 font-ui text-xs text-moss">
            /admin
          </code>
      ...
      <footer className="border-t border-olive/20 px-6 py-8 text-center">
        <p className="font-ui text-[10px] uppercase tracking-[0.2em] text-ink/45">
