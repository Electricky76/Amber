  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl text-center">
        <p className="font-label text-lg font-normal leading-relaxed tracking-normal text-ink/85 md:text-xl">
        ...
        <p className="mt-6 font-label text-lg font-normal leading-relaxed tracking-normal text-ink/85 md:text-xl">
