    ...
    >
      <div className="mx-auto max-w-3xl text-center">
        ...
        <Link
          ...
          className="font-ui mt-10 inline-flex items-center justify-center border border-offwhite/35 bg-transparent px-10 py-4 text-xs font-semibold uppercase tracking-[0.28em] text-offwhite transition hover:bg-offwhite hover:text-moss"
        >
          @{IG_HANDLE}
        </Link>
      </div>
